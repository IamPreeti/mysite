...
//Getting Connection using MS Access
	...
	public static Connection getConnection() throws Exception{
	    ...
	    try{
		String url = "jdbc:mysql://root@localhost:3306/test";
...
// Group Queries
	...
	public static String getGroupByEmail(String eMail) throws Exception{
	    ...
	    String groupid = null;
	     ...
	     try{
		dbConn = getConnection();
		pStmt = dbConn.prepareStatement("SELECT groupid FROM emailaddress WHERE emailaddress = ?");
