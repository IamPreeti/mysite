...
public class EMailBO {
	...
	public ArrayList<EMailAddressVOO> getAllEMailAddressList() throws EMailValidationException, Exception{
		EMailDBAccess eMailDBAccess = new EMailDBAccess();
		ArrayList<EMailAddressVOO> eMailList = (ArrayList) eMailDBAccess.getAllEMailAdressEntries();
		return eMailList;
	}
...
//Group Calls
	...
	public String getGroupByEmail(String eMail) throws EMailValidationException, Exception{
		EMailDBAccess eMailDBAccess = new EMailDBAccess();
		String groupId = eMailDBAccess.getGroupByEmail(eMail);
		return groupId;
	}
